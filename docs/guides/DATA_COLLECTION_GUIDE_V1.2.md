...
- `docs/foundation/MASTER_REQUIREMENTS_V2.27.md` (REQ-DATA-001 through REQ-DATA-008, REQ-ELO-*)
- `docs/foundation/ARCHITECTURE_DECISIONS.md` (ADR-002: Decimal Precision, ADR-053: Data Validation, ADR-076: Sports Data Source Tiering, ADR-109: Elo Computation)
