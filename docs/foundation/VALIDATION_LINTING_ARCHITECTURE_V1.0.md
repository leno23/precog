...
- **Requirements:** `MASTER_REQUIREMENTS_V2.27.md` - REQ-VALIDATION-001, REQ-VALIDATION-002
- **ADRs:** `ARCHITECTURE_DECISIONS.md` - ADR-048 (Ruff), ADR-050 (Doc Validation), ADR-051 (Layered Validation), ADR-054 (Bandit→Ruff Migration), ADR-075 (Multi-Source Warning Governance), ADR-076 (Dynamic Ensemble Weights), ADR-077 (Strategy vs Method Separation)
